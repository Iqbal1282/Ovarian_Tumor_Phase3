...
project_title = "Imagenet Ovarian Cancer Classification MMOTU"
...
# Model
model = MultiClassificationTorch_Imagenet(backbone_name= 'efficientnetv2_m', pretrained= False).to(device=device)
