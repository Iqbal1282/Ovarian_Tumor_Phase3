...
from models import BinaryClassification, MultiClassClassification, MultiClassClassificationEfficientNet
...
model = MultiClassClassificationEfficientNet(num_classes= 8)
