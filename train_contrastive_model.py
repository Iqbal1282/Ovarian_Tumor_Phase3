...
from contrast_models import ThreeModalTransformerClassifier
...
project_title = "Contrastive Ovarian Cancer Classification MMOTU"
...
train_config = {
    ...
    "model_type": "ThreeModalTransformerClassifier",
...
checkpoint_dir = f"checkpoints/contrast_model_mmotu/{commit_log}"
